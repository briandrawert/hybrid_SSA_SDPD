...
DumpStyle(ssa_tsdpd,DumpSsaTsdpd)

#else

#ifndef DUMP_SSA_TSDPD_H
#define DUMP_SSA_TSDPD_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpSsaTsdpd : public Dump {
 public:
  DumpSsaTsdpd(class LAMMPS *, int, char **);
  virtual ~DumpSsaTsdpd();
 ...
 protected:
  ...
  typedef void (DumpSsaTsdpd::*FnPtrHeader)(bigint);
  ...
  typedef void (DumpSsaTsdpd::*FnPtrPack)(int);
  ...
  void pack_C(int); //added
  void pack_Cd(int); //added
