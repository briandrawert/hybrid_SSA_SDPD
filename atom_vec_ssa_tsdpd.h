...
AtomStyle(ssa_tsdpd,AtomVecSsaTsdpd)

#else

#ifndef LMP_ATOM_VEC_SSA_TSDPD_H
#define LMP_ATOM_VEC_SSA_TSDPD_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecSsaTsdpd : public AtomVec {
 public:
  AtomVecSsaTsdpd(class LAMMPS *);
  ~AtomVecSsaTsdpd() {}
