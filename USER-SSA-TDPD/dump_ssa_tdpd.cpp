...
DumpSsaTdpd::DumpSsaTdpd(LAMMPS *lmp, int narg, char **arg) :
  Dump(lmp, narg, arg),
...
void DumpSsaTdpd::init_style()
{
  ...
  if (binary && domain->triclinic == 0)
    header_choice = &DumpSsaTdpd::header_binary;
  else if (binary && domain->triclinic == 1)
    header_choice = &DumpSsaTdpd::header_binary_triclinic;
  else if (!binary && domain->triclinic == 0)
    header_choice = &DumpSsaTdpd::header_item;
  else if (!binary && domain->triclinic == 1)
    header_choice = &DumpSsaTdpd::header_item_triclinic;

  if (binary) write_choice = &DumpSsaTdpd::write_binary;
  else if (buffer_flag == 1) write_choice = &DumpSsaTdpd::write_string;
  else write_choice = &DumpSsaTdpd::write_lines;
...
void DumpSsaTdpd::write_header(bigint ndump)
{
...
void DumpSsaTdpd::header_binary(bigint ndump)
{
...
void DumpSsaTdpd::header_binary_triclinic(bigint ndump)
{
  fwrite(&update->ntimestep,sizeof(bigint),1,fp);
  fwrite(&ndump,sizeof(bigint),1,fp);
  fwrite(&domain->triclinic,sizeof(int),1,fp);
...
void DumpSsaTdpd::header_item(bigint ndump)
{
...
void DumpSsaTdpd::header_item_triclinic(bigint ndump)
{
  fprintf(fp,"ITEM: TIMESTEP\n");
  fprintf(fp,BIGINT_FORMAT "\n",update->ntimestep);
  fprintf(fp,"ITEM: NUMBER OF ATOMS\n");
...
void DumpSsaTdpd::pack(tagint *ids)
{
...
int DumpSsaTdpd::convert_string(int n, double *mybuf)
{
  int i,j;
  int offset = 0;
  int m = 0;
...
void DumpSsaTdpd::write_data(int n, double *mybuf)
{
...
void DumpSsaTdpd::write_binary(int n, double *mybuf)
{
  n *= size_one;
...
void DumpSsaTdpd::write_string(int n, double *mybuf)
{
...
void DumpSsaTdpd::write_lines(int n, double *mybuf)
{
  int i,j;
  int m = 0;
  for (i = 0; i < n; i++) {
...
int DumpSsaTdpd::parse_fields(int narg, char **arg)
{
  // customize by adding to if statement
  ...
  for (int iarg = 0; iarg < narg; iarg++) {
    ...
    if (strcmp(arg[iarg],"id") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_id;
      if (sizeof(tagint) == sizeof(smallint)) vtype[i] = INT;
      else vtype[i] = BIGINT;
    } else if (strcmp(arg[iarg],"mol") == 0) {
      if (!atom->molecule_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_molecule;
      if (sizeof(tagint) == sizeof(smallint)) vtype[i] = INT;
      else vtype[i] = BIGINT;
    } else if (strcmp(arg[iarg],"proc") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_proc;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"procp1") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_procp1;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"type") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_type;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"element") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_type;
      vtype[i] = STRING;
    } else if (strcmp(arg[iarg],"mass") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_mass;
      vtype[i] = DOUBLE;

    //added

    } else if (strncmp(arg[iarg],"C_",2) == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_C;
      vtype[i] = DOUBLE;
	...
	if (atoi(ptr+1) > atom->num_tdpd_species - 1)
	  error->all(FLERR,"Argument in C_[] is greater than the number of species");
      ...
      pack_choice[i] = &DumpSsaTdpd::pack_x;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"y") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_y;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"z") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_z;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"xs") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_xs_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_xs;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"ys") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_ys_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_ys;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zs") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_zs_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_zs;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"xu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_xu_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_xu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"yu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_yu_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_yu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_zu_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_zu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"xsu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_xsu_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_xsu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"ysu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_ysu_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_ysu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zsu") == 0) {
      if (domain->triclinic) pack_choice[i] = &DumpSsaTdpd::pack_zsu_triclinic;
      else pack_choice[i] = &DumpSsaTdpd::pack_zsu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"ix") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_ix;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"iy") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_iy;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"iz") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_iz;
      vtype[i] = INT;

    } else if (strcmp(arg[iarg],"vx") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_vx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vy") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_vy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vz") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_vz;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fx") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_fx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fy") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_fy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fz") == 0) {
      pack_choice[i] = &DumpSsaTdpd::pack_fz;
      vtype[i] = DOUBLE;

    } else if (strcmp(arg[iarg],"q") == 0) {
      if (!atom->q_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_q;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"mux") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_mux;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"muy") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_muy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"muz") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_muz;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"mu") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_mu;
      vtype[i] = DOUBLE;

    } else if (strcmp(arg[iarg],"radius") == 0) {
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_radius;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"diameter") == 0) {
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_diameter;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"omegax") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_omegax;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"omegay") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_omegay;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"omegaz") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_omegaz;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"angmomx") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_angmomx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"angmomy") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_angmomy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"angmomz") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_angmomz;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"tqx") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_tqx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"tqy") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_tqy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"tqz") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[i] = &DumpSsaTdpd::pack_tqz;
      vtype[i] = DOUBLE;
    ...
    // if no trailing [], then arg is set to 0, else arg is int between []
      ...
      pack_choice[i] = &DumpSsaTdpd::pack_compute;
      vtype[i] = DOUBLE;
    ...
    // if no trailing [], then arg is set to 0, else arg is between []
      ...
      pack_choice[i] = &DumpSsaTdpd::pack_fix;
      vtype[i] = DOUBLE;
    ...
    // variable value = v_name
      ...
      pack_choice[i] = &DumpSsaTdpd::pack_variable;
      vtype[i] = DOUBLE;
    ...
    // custom per-atom floating point value = d_ID
      ...
      pack_choice[i] = &DumpSsaTdpd::pack_custom;
      vtype[i] = DOUBLE;
...
int DumpSsaTdpd::add_compute(char *id)
{
  int icompute;
...
int DumpSsaTdpd::add_fix(char *id)
{
  int ifix;
...
int DumpSsaTdpd::add_variable(char *id)
{
  int ivariable;
...
int DumpSsaTdpd::add_custom(char *id, int flag)
{
  int icustom;
...
int DumpSsaTdpd::modify_param(int narg, char **arg)
{
...
bigint DumpSsaTdpd::memory_usage()
{
...
void DumpSsaTdpd::pack_compute(int n)
{
...
void DumpSsaTdpd::pack_fix(int n)
{
...
void DumpSsaTdpd::pack_variable(int n)
{
...
void DumpSsaTdpd::pack_custom(int n)
{
...
void DumpSsaTdpd::pack_id(int n)
{
  tagint *tag = atom->tag;
...
void DumpSsaTdpd::pack_molecule(int n)
{
  tagint *molecule = atom->molecule;
...
void DumpSsaTdpd::pack_proc(int n)
{
  for (int i = 0; i < nchoose; i++) {
    buf[n] = me;
    n += size_one;
...
void DumpSsaTdpd::pack_procp1(int n)
{
  for (int i = 0; i < nchoose; i++) {
    buf[n] = me+1;
    n += size_one;
...
void DumpSsaTdpd::pack_type(int n)
{
  int *type = atom->type;
...
void DumpSsaTdpd::pack_mass(int n)
{
  int *type = atom->type;
  double *mass = atom->mass;
...
void DumpSsaTdpd::pack_xs(int n)
{
  double **x = atom->x;
...
void DumpSsaTdpd::pack_ys(int n)
{
  double **x = atom->x;
...
void DumpSsaTdpd::pack_zs(int n)
{
  double **x = atom->x;
...
void DumpSsaTdpd::pack_xs_triclinic(int n)
{
  int j;
  double **x = atom->x;
...
void DumpSsaTdpd::pack_ys_triclinic(int n)
{
  int j;
  double **x = atom->x;
...
void DumpSsaTdpd::pack_zs_triclinic(int n)
{
  double **x = atom->x;
...
void DumpSsaTdpd::pack_xu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_yu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_zu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_xu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_yu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_zu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_xsu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_ysu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_zsu(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_xsu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_ysu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_zsu_triclinic(int n)
{
  int j;
  double **x = atom->x;
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_ix(int n)
{
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_iy(int n)
{
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_iz(int n)
{
  imageint *image = atom->image;
...
void DumpSsaTdpd::pack_vx(int n)
{
  double **v = atom->v;
...
void DumpSsaTdpd::pack_vy(int n)
{
  double **v = atom->v;
...
void DumpSsaTdpd::pack_vz(int n)
{
  double **v = atom->v;
...
void DumpSsaTdpd::pack_fx(int n)
{
  double **f = atom->f;
...
void DumpSsaTdpd::pack_fy(int n)
{
  double **f = atom->f;
...
void DumpSsaTdpd::pack_fz(int n)
{
  double **f = atom->f;
...
void DumpSsaTdpd::pack_mux(int n)
{
  double **mu = atom->mu;
...
void DumpSsaTdpd::pack_muy(int n)
{
  double **mu = atom->mu;
...
void DumpSsaTdpd::pack_muz(int n)
{
  double **mu = atom->mu;
...
void DumpSsaTdpd::pack_mu(int n)
{
  double **mu = atom->mu;
...
void DumpSsaTdpd::pack_radius(int n)
{
  double *radius = atom->radius;
...
void DumpSsaTdpd::pack_diameter(int n)
{
  double *radius = atom->radius;
...
void DumpSsaTdpd::pack_omegax(int n)
{
...
void DumpSsaTdpd::pack_omegay(int n)
{
  double **omega = atom->omega;
...
void DumpSsaTdpd::pack_omegaz(int n)
{
  double **omega = atom->omega;
...
void DumpSsaTdpd::pack_angmomx(int n)
{
...
void DumpSsaTdpd::pack_angmomy(int n)
{
  double **angmom = atom->angmom;
...
void DumpSsaTdpd::pack_angmomz(int n)
{
  double **angmom = atom->angmom;
...
void DumpSsaTdpd::pack_tqx(int n)
{
...
void DumpSsaTdpd::pack_tqy(int n)
{
  double **torque = atom->torque;
...
void DumpSsaTdpd::pack_tqz(int n)
{
  double **torque = atom->torque;
