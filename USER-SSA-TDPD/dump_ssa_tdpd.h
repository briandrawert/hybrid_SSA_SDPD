...
DumpStyle(ssa_tdpd,DumpSsaTdpd)

#else

#ifndef DUMP_SSA_TDPD_H
#define DUMP_SSA_TDPD_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpSsaTdpd : public Dump {
 public:
  DumpSsaTdpd(class LAMMPS *, int, char **);
  virtual ~DumpSsaTdpd();
 ...
 protected:
  ...
  typedef void (DumpSsaTdpd::*FnPtrHeader)(bigint);
  ...
  typedef void (DumpSsaTdpd::*FnPtrPack)(int);
