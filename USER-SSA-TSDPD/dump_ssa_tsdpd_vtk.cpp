...
DumpSsaTsdpdVTK::DumpSsaTsdpdVTK(LAMMPS *lmp, int narg, char **arg) :
  DumpSsaTsdpd(lmp, narg, arg)
{
...
DumpSsaTsdpdVTK::~DumpSsaTsdpdVTK()
{
...
void DumpSsaTsdpdVTK::init_style()
{
  ...
  header_choice = &DumpSsaTsdpdVTK::header_vtk;

  if (vtk_file_format == VTP || vtk_file_format == PVTP)
    write_choice = &DumpSsaTsdpdVTK::write_vtp;
  else if (vtk_file_format == VTU || vtk_file_format == PVTU)
    write_choice = &DumpSsaTsdpdVTK::write_vtu;
  else
    write_choice = &DumpSsaTsdpdVTK::write_vtk;
...
void DumpSsaTsdpdVTK::write_header(bigint)
{
}

/* ---------------------------------------------------------------------- */

void DumpSsaTsdpdVTK::header_vtk(bigint)
{
}

/* ---------------------------------------------------------------------- */

int DumpSsaTsdpdVTK::count()
{
...
void DumpSsaTsdpdVTK::pack(tagint *ids)
{
...
void DumpSsaTsdpdVTK::write_data(int n, double *mybuf)
{
...
void DumpSsaTsdpdVTK::setFileCurrent() {
...
void DumpSsaTsdpdVTK::buf2arrays(int n, double *mybuf)
{
...
void DumpSsaTsdpdVTK::prepare_domain_data(vtkRectilinearGrid *rgrid)
{
...
void DumpSsaTsdpdVTK::prepare_domain_data_triclinic(vtkUnstructuredGrid *hexahedronGrid)
{
...
void DumpSsaTsdpdVTK::write_domain_vtk()
{
...
void DumpSsaTsdpdVTK::write_domain_vtk_triclinic()
{
...
void DumpSsaTsdpdVTK::write_domain_vtr()
{
...
void DumpSsaTsdpdVTK::write_domain_vtu_triclinic()
{
...
void DumpSsaTsdpdVTK::write_vtk(int n, double *mybuf)
{
...
void DumpSsaTsdpdVTK::write_vtp(int n, double *mybuf)
{
...
void DumpSsaTsdpdVTK::write_vtu(int n, double *mybuf)
{
...
void DumpSsaTsdpdVTK::reset_vtk_data_containers()
{
...
int DumpSsaTsdpdVTK::parse_fields(int narg, char **arg)
{

  pack_choice[X] = &DumpSsaTsdpdVTK::pack_x;
  vtype[X] = DOUBLE;
  name[X] = "x";
  pack_choice[Y] = &DumpSsaTsdpdVTK::pack_y;
  vtype[Y] = DOUBLE;
  name[Y] = "y";
  pack_choice[Z] = &DumpSsaTsdpdVTK::pack_z;
  vtype[Z] = DOUBLE;
  name[Z] = "z";
  ...
  for (int iarg = 5; iarg < narg; iarg++) {
    ...
    if (strcmp(arg[iarg],"id") == 0) {
      pack_choice[ID] = &DumpSsaTsdpdVTK::pack_id;
      vtype[ID] = INT;
      name[ID] = arg[iarg];
    } else if (strcmp(arg[iarg],"mol") == 0) {
      if (!atom->molecule_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[MOL] = &DumpSsaTsdpdVTK::pack_molecule;
      vtype[MOL] = INT;
      name[MOL] = arg[iarg];
    } else if (strcmp(arg[iarg],"proc") == 0) {
      pack_choice[PROC] = &DumpSsaTsdpdVTK::pack_proc;
      vtype[PROC] = INT;
      name[PROC] = arg[iarg];
    } else if (strcmp(arg[iarg],"procp1") == 0) {
      pack_choice[PROCP1] = &DumpSsaTsdpdVTK::pack_procp1;
      vtype[PROCP1] = INT;
      name[PROCP1] = arg[iarg];
    } else if (strcmp(arg[iarg],"type") == 0) {
      pack_choice[TYPE] = &DumpSsaTsdpdVTK::pack_type;
      vtype[TYPE] = INT;
      name[TYPE] =arg[iarg];
    } else if (strcmp(arg[iarg],"element") == 0) {
      pack_choice[ELEMENT] = &DumpSsaTsdpdVTK::pack_type;
      vtype[ELEMENT] = STRING;
      name[ELEMENT] = arg[iarg];
    } else if (strcmp(arg[iarg],"mass") == 0) {
      pack_choice[MASS] = &DumpSsaTsdpdVTK::pack_mass;
      vtype[MASS] = DOUBLE;
      name[MASS] = arg[iarg];
      ...
      if (domain->triclinic) pack_choice[XS] = &DumpSsaTsdpdVTK::pack_xs_triclinic;
      else pack_choice[XS] = &DumpSsaTsdpdVTK::pack_xs;
      vtype[XS] = DOUBLE;
      name[XS] = arg[iarg];
    } else if (strcmp(arg[iarg],"ys") == 0) {
      if (domain->triclinic) pack_choice[YS] = &DumpSsaTsdpdVTK::pack_ys_triclinic;
      else pack_choice[YS] = &DumpSsaTsdpdVTK::pack_ys;
      vtype[YS] = DOUBLE;
      name[YS] = arg[iarg];
    } else if (strcmp(arg[iarg],"zs") == 0) {
      if (domain->triclinic) pack_choice[ZS] = &DumpSsaTsdpdVTK::pack_zs_triclinic;
      else pack_choice[ZS] = &DumpSsaTsdpdVTK::pack_zs;
      vtype[ZS] = DOUBLE;
      name[ZS] = arg[iarg];
    } else if (strcmp(arg[iarg],"xu") == 0) {
      if (domain->triclinic) pack_choice[XU] = &DumpSsaTsdpdVTK::pack_xu_triclinic;
      else pack_choice[XU] = &DumpSsaTsdpdVTK::pack_xu;
      vtype[XU] = DOUBLE;
      name[XU] = arg[iarg];
    } else if (strcmp(arg[iarg],"yu") == 0) {
      if (domain->triclinic) pack_choice[YU] = &DumpSsaTsdpdVTK::pack_yu_triclinic;
      else pack_choice[YU] = &DumpSsaTsdpdVTK::pack_yu;
      vtype[YU] = DOUBLE;
      name[YU] = arg[iarg];
    } else if (strcmp(arg[iarg],"zu") == 0) {
      if (domain->triclinic) pack_choice[ZU] = &DumpSsaTsdpdVTK::pack_zu_triclinic;
      else pack_choice[ZU] = &DumpSsaTsdpdVTK::pack_zu;
      vtype[ZU] = DOUBLE;
      name[ZU] = arg[iarg];
    } else if (strcmp(arg[iarg],"xsu") == 0) {
      if (domain->triclinic) pack_choice[XSU] = &DumpSsaTsdpdVTK::pack_xsu_triclinic;
      else pack_choice[XSU] = &DumpSsaTsdpdVTK::pack_xsu;
      vtype[XSU] = DOUBLE;
      name[XSU] = arg[iarg];
    } else if (strcmp(arg[iarg],"ysu") == 0) {
      if (domain->triclinic) pack_choice[YSU] = &DumpSsaTsdpdVTK::pack_ysu_triclinic;
      else pack_choice[YSU] = &DumpSsaTsdpdVTK::pack_ysu;
      vtype[YSU] = DOUBLE;
      name[YSU] = arg[iarg];
    } else if (strcmp(arg[iarg],"zsu") == 0) {
      if (domain->triclinic) pack_choice[ZSU] = &DumpSsaTsdpdVTK::pack_zsu_triclinic;
      else pack_choice[ZSU] = &DumpSsaTsdpdVTK::pack_zsu;
      vtype[ZSU] = DOUBLE;
      name[ZSU] = arg[iarg];
    } else if (strcmp(arg[iarg],"ix") == 0) {
      pack_choice[IX] = &DumpSsaTsdpdVTK::pack_ix;
      vtype[IX] = INT;
      name[IX] = arg[iarg];
    } else if (strcmp(arg[iarg],"iy") == 0) {
      pack_choice[IY] = &DumpSsaTsdpdVTK::pack_iy;
      vtype[IY] = INT;
      name[IY] = arg[iarg];
    } else if (strcmp(arg[iarg],"iz") == 0) {
      pack_choice[IZ] = &DumpSsaTsdpdVTK::pack_iz;
      vtype[IZ] = INT;
      name[IZ] = arg[iarg];

    } else if (strcmp(arg[iarg],"vx") == 0) {
      pack_choice[VX] = &DumpSsaTsdpdVTK::pack_vx;
      vtype[VX] = DOUBLE;
      name[VX] = arg[iarg];
    } else if (strcmp(arg[iarg],"vy") == 0) {
      pack_choice[VY] = &DumpSsaTsdpdVTK::pack_vy;
      vtype[VY] = DOUBLE;
      name[VY] = arg[iarg];
    } else if (strcmp(arg[iarg],"vz") == 0) {
      pack_choice[VZ] = &DumpSsaTsdpdVTK::pack_vz;
      vtype[VZ] = DOUBLE;
      name[VZ] = arg[iarg];

    } else if (strcmp(arg[iarg],"fx") == 0) {
      pack_choice[FX] = &DumpSsaTsdpdVTK::pack_fx;
      vtype[FX] = DOUBLE;
      name[FX] = arg[iarg];
    } else if (strcmp(arg[iarg],"fy") == 0) {
      pack_choice[FY] = &DumpSsaTsdpdVTK::pack_fy;
      vtype[FY] = DOUBLE;
      name[FY] = arg[iarg];
    } else if (strcmp(arg[iarg],"fz") == 0) {
      pack_choice[FZ] = &DumpSsaTsdpdVTK::pack_fz;
      vtype[FZ] = DOUBLE;
      name[FZ] = arg[iarg];
    } else if (strcmp(arg[iarg],"q") == 0) {
      if (!atom->q_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[Q] = &DumpSsaTsdpdVTK::pack_q;
      vtype[Q] = DOUBLE;
      name[Q] = arg[iarg];
    } else if (strcmp(arg[iarg],"mux") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[MUX] = &DumpSsaTsdpdVTK::pack_mux;
      vtype[MUX] = DOUBLE;
      name[MUX] = arg[iarg];
    } else if (strcmp(arg[iarg],"muy") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[MUY] = &DumpSsaTsdpdVTK::pack_muy;
      vtype[MUY] = DOUBLE;
      name[MUY] = arg[iarg];
    } else if (strcmp(arg[iarg],"muz") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[MUZ] = &DumpSsaTsdpdVTK::pack_muz;
      vtype[MUZ] = DOUBLE;
      name[MUZ] = arg[iarg];
    } else if (strcmp(arg[iarg],"mu") == 0) {
      if (!atom->mu_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[MU] = &DumpSsaTsdpdVTK::pack_mu;
      vtype[MU] = DOUBLE;
      name[MU] = arg[iarg];
      ...
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[RADIUS] = &DumpSsaTsdpdVTK::pack_radius;
      vtype[RADIUS] = DOUBLE;
      name[RADIUS] = arg[iarg];
    } else if (strcmp(arg[iarg],"diameter") == 0) {
      if (!atom->radius_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[DIAMETER] = &DumpSsaTsdpdVTK::pack_diameter;
      vtype[DIAMETER] = DOUBLE;
      name[DIAMETER] = arg[iarg];
    } else if (strcmp(arg[iarg],"omegax") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[OMEGAX] = &DumpSsaTsdpdVTK::pack_omegax;
      vtype[OMEGAX] = DOUBLE;
      name[OMEGAX] = arg[iarg];
    } else if (strcmp(arg[iarg],"omegay") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[OMEGAY] = &DumpSsaTsdpdVTK::pack_omegay;
      vtype[OMEGAY] = DOUBLE;
      name[OMEGAY] = arg[iarg];
    } else if (strcmp(arg[iarg],"omegaz") == 0) {
      if (!atom->omega_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[OMEGAZ] = &DumpSsaTsdpdVTK::pack_omegaz;
      vtype[OMEGAZ] = DOUBLE;
      name[OMEGAZ] = arg[iarg];
    } else if (strcmp(arg[iarg],"angmomx") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[ANGMOMX] = &DumpSsaTsdpdVTK::pack_angmomx;
      vtype[ANGMOMX] = DOUBLE;
      name[ANGMOMX] = arg[iarg];
    } else if (strcmp(arg[iarg],"angmomy") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[ANGMOMY] = &DumpSsaTsdpdVTK::pack_angmomy;
      vtype[ANGMOMY] = DOUBLE;
      name[ANGMOMY] = arg[iarg];
    } else if (strcmp(arg[iarg],"angmomz") == 0) {
      if (!atom->angmom_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[ANGMOMZ] = &DumpSsaTsdpdVTK::pack_angmomz;
      vtype[ANGMOMZ] = DOUBLE;
      name[ANGMOMZ] = arg[iarg];
    } else if (strcmp(arg[iarg],"tqx") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[TQX] = &DumpSsaTsdpdVTK::pack_tqx;
      vtype[TQX] = DOUBLE;
      name[TQX] = arg[iarg];
    } else if (strcmp(arg[iarg],"tqy") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[TQY] = &DumpSsaTsdpdVTK::pack_tqy;
      vtype[TQY] = DOUBLE;
      name[TQY] = arg[iarg];
    } else if (strcmp(arg[iarg],"tqz") == 0) {
      if (!atom->torque_flag)
        error->all(FLERR,"Dumping an atom property that isn't allocated");
      pack_choice[TQZ] = &DumpSsaTsdpdVTK::pack_tqz;
      vtype[TQZ] = DOUBLE;
      name[TQZ] = arg[iarg];


      //added (concentration C of species [] =  C_[])
    } else if (strncmp(arg[iarg],"C_",2) == 0) {
      pack_choice[i] = &DumpSsaTsdpdVTK::pack_C;
      vtype[i] = DOUBLE;
      ...
      if (ptr) {
        if (suffix[strlen(suffix)-1] != ']')
          error->all(FLERR,"Invalid attribute in dump ssa_tsdpd/vtk command");
	if (atoi(ptr+1) > atom->num_tdpd_species - 1)
      ...
      //added (concentration Cd of species [] =  Cd_[])
    } else if (strncmp(arg[iarg],"Cd_",2) == 0) {
      pack_choice[i] = &DumpSsaTsdpdVTK::pack_Cd;
    ...
    // if no trailing [], then arg is set to 0, else arg is int between []
      ...
      pack_choice[ATTRIBUTES+i] = &DumpSsaTsdpdVTK::pack_compute;
    ...
    // if no trailing [], then arg is set to 0, else arg is between []
      ...
      pack_choice[ATTRIBUTES+i] = &DumpSsaTsdpdVTK::pack_fix;
      vtype[ATTRIBUTES+i] = DOUBLE;
    ...
    // variable value = v_name
      ...
      pack_choice[ATTRIBUTES+i] = &DumpSsaTsdpdVTK::pack_variable;
      vtype[ATTRIBUTES+i] = DOUBLE;
    ...
    // custom per-atom floating point value = d_ID
      ...
      pack_choice[ATTRIBUTES+i] = &DumpSsaTsdpdVTK::pack_custom;
      vtype[ATTRIBUTES+i] = DOUBLE;
...
void DumpSsaTsdpdVTK::identify_vectors()
{
...
int DumpSsaTsdpdVTK::add_compute(char *id)
{
...
int DumpSsaTsdpdVTK::add_fix(char *id)
{
  int ifix;
...
int DumpSsaTsdpdVTK::add_variable(char *id)
{
  int ivariable;
...
int DumpSsaTsdpdVTK::add_custom(char *id, int flag)
{
  int icustom;
...
int DumpSsaTsdpdVTK::modify_param(int narg, char **arg)
{
  ...
  if (strcmp(arg[0],"thresh") == 0) {
    ...
    //added
    else if (strncmp(arg[1],"C_",2) == 0) thresh_array[nthresh]  = VX;
    else if (strncmp(arg[1],"Cd_",2) == 0) thresh_array[nthresh] = IX;
...
bigint DumpSsaTsdpdVTK::memory_usage()
{
...
void DumpSsaTsdpdVTK::pack_compute(int n)
{
...
void DumpSsaTsdpdVTK::pack_fix(int n)
{
...
void DumpSsaTsdpdVTK::pack_variable(int n)
{
...
void DumpSsaTsdpdVTK::pack_custom(int n)
{
...
/*----------------------------------------------------------------------- */
//added
void DumpSsaTsdpdVTK::pack_C(int n)
{
  double **C = atom->C;
  int index = argindex[current_pack_choice_key];
...
/*----------------------------------------------------------------------- */
//added
void DumpSsaTsdpdVTK::pack_Cd(int n)
{
  int **Cd = atom->Cd;
  int index = argindex[current_pack_choice_key];
  double *mass = atom->mass;
  ...
  if (atom->Cd_concentration_flag == 1) {
    for (int i = 0; i < nchoose; i++) {
      buf[n] = (double) Cd[clist[i]][index] * rho[clist[i]] / mass[type[clist[i]]] / atom->concentration_conversion;  // concentration [mol/m3]
      n += size_one;
    }
  }
