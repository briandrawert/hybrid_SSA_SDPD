...
for x in range(1,101):
	...
	for n in range(1,7):
		t = (n-1)*2000
		FileNow = '/home/bjacob/Desktop/SSA_CORRECTED/examples/ssa_tsdpd/cylinder_annihilation/temporal_analysis/17x1/%d/dump%d.vtk' % (x,t)
	...
	# create a new 'Plot Over Line'
        ...
        plotOverLine1.Source.Resolution = 16
        ...
        # save data
        SaveData('/home/bjacob/Desktop/SSA_CORRECTED/examples/ssa_tsdpd/cylinder_annihilation/temporal_analysis/17x1/%d/cylinder_annihilation_results.csv' % (x), proxy=plotOverLine1, Precision=16,WriteAllTimeSteps=1)
