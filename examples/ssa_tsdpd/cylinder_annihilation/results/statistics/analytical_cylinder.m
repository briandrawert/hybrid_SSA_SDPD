function data_pack_exact = analytical_cylinder(nx,ny)

% Analytical solution (2 x reaction-diffusion equations, steady-state)
...
% main loop %CHANGE IT TO BRIAN'S SOLUTION
for i = 1:nx
    for j=1:ny
       sum = 0;
       for k=1:n
