...
for x in range(1,101):
	...
	for n in range(1,101):
		t = (n-1)*100
		FileNow = '/home/bjacob/Desktop/SSA_CORRECTED/examples/ssa_tsdpd/diffusion1d/65x1/%d/dump%d.vtk' % (x,t)
	...
	# save data
	SaveData('/home/bjacob/Desktop/SSA_CORRECTED/examples/ssa_tsdpd/diffusion1d/65x1/%d/diffusion1d_results.csv' % (x), proxy=dump, Precision=16,
		WriteAllTimeSteps=1)
