...
DumpStyle(ssa_tsdpd/vtk,DumpSsaTsdpdVTK)

#else

#ifndef DUMP_SSA_TSDPD_VTK_H
#define DUMP_SSA_TSDPD_VTK_H
 ...
 */
class DumpSsaTsdpdVTK : public DumpSsaTsdpd {
 public:
  DumpSsaTsdpdVTK(class LAMMPS *, int, char **);
  virtual ~DumpSsaTsdpdVTK();
 ...
 protected:
  ...
  typedef void (DumpSsaTsdpdVTK::*FnPtrHeader)(bigint);
  FnPtrHeader header_choice;           // ptr to write header functions
  void header_vtk(bigint);

  typedef void (DumpSsaTsdpdVTK::*FnPtrWrite)(int, double *);
  ...
  typedef void (DumpSsaTsdpdVTK::*FnPtrPack)(int);
