...
DumpStyle(ssa_tdpd/vtk,DumpSsaTdpdVTK)

#else

#ifndef DUMP_SSA_TDPD_VTK_H
#define DUMP_SSA_TDPD_VTK_H
 ...
 */
class DumpSsaTdpdVTK : public DumpSsaTdpd {
 public:
  DumpSsaTdpdVTK(class LAMMPS *, int, char **);
  virtual ~DumpSsaTdpdVTK();
 ...
 protected:
  ...
  typedef void (DumpSsaTdpdVTK::*FnPtrHeader)(bigint);
  FnPtrHeader header_choice;           // ptr to write header functions
  void header_vtk(bigint);

  typedef void (DumpSsaTdpdVTK::*FnPtrWrite)(int, double *);
  ...
  typedef void (DumpSsaTdpdVTK::*FnPtrPack)(int);
